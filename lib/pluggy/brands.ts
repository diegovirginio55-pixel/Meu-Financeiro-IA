...
const BRANDS: Record<string, BankBrand> = {
  ...
  Bradesco: { bg: "#CC092F", fg: "#FFFFFF", label: "Bradesco", logo: "/bancos/bradesco.svg" },
  Santander: { bg: "#EC0000", fg: "#FFFFFF", label: "Santander", logo: "/bancos/santander.svg" },
  "C6 Bank": { bg: "#222222", fg: "#FFFFFF", label: "C6 Bank", logo: "/bancos/c6.svg" },
